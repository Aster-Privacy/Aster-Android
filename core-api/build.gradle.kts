...
android {
    ...
    buildTypes {
        getByName("debug") {
            ...
            val localApiPort = providers.gradleProperty("astermail.localApiPort").orNull ?: "3000"
            val debugUrl = if (localApi) "http://10.0.2.2:$localApiPort" else "https://app.astermail.org"
