...
object AsterColors {
    ...
    val light_bg_hover = Color(0xFFECECEC)
    ...
    val light_text_muted = Color(0xFF5F6470)
    ...
    val dark_bg_primary = Color(0xFF121212)
    val dark_bg_secondary = Color(0xFF0A0A0A)
    val dark_bg_tertiary = Color(0xFF121212)
    val dark_bg_hover = Color(0xFF1A1A1A)
    val dark_bg_selected = Color(0xFF142744)
    val dark_bg_card = Color(0xFF121212)
    val dark_border_primary = Color(0xFF333333)
    val dark_border_secondary = Color(0xFF2A2A2A)
    ...
    val dark_avatar_bg = Color(0xFF2A2A2A)
    val dark_avatar_text = Color(0xFF9CA3AF)
    val dark_indicator_bg = Color(0xFF121212)
    val dark_indicator_border = Color(0xFF2A2A2A)
    val dark_sidebar_bg = Color(0xFF0A0A0A)
    val dark_sidebar_hover = Color(0xFF0F0F0F)
    val dark_sidebar = Color(0xFF18181B)
    val dark_sidebar_foreground = Color(0xFFFAFAFA)
    val dark_sidebar_accent = Color(0xFF27272A)
    val dark_sidebar_border = Color(0xFF333333)
    val dark_modal_bg = Color(0xFF121212)
    val dark_modal_overlay = Color(0xD9000000)
    val dark_dropdown_bg = Color(0xFF121212)
    val dark_dropdown_hover = Color(0xFF252525)
    val dark_input_bg = Color(0xFF1A1A1A)
    val dark_input_border = Color(0xFF2A2A2A)
    val dark_card = Color(0xFF18181B)
    val dark_card_foreground = Color(0xFFFAFAFA)
    val dark_popover = Color(0xFF18181B)
    ...
    val dark_thread_card_bg = Color(0xFF181818)
    val dark_thread_card_bg_hover = Color(0xFF222222)
    val dark_thread_card_border = Color(0xFF2A2A2A)
    val dark_thread_header_bg = Color(0xFF1A1A1A)
    val dark_thread_content_bg = Color(0xFF121212)
}

val light_color_scheme = color_scheme_for(is_dark = false, palette = null)
val dark_color_scheme = color_scheme_for(is_dark = true, palette = null)

fun color_scheme_for(is_dark: Boolean, palette: ColorThemePalette?) =
    if (is_dark) build_dark_color_scheme(palette) else build_light_color_scheme(palette)
...
private fun build_light_color_scheme(palette: ColorThemePalette?) = lightColorScheme(
    ...
    onSecondaryContainer = palette?.text_primary ?: AsterColors.light_text_primary,
    tertiary = palette?.text_tertiary ?: AsterColors.light_text_tertiary,
    onTertiary = Color.White,
    background = palette?.bg_primary ?: AsterColors.light_bg_primary,
    onBackground = palette?.text_primary ?: AsterColors.light_text_primary,
    surface = palette?.bg_card ?: AsterColors.light_bg_card,
    onSurface = palette?.text_primary ?: AsterColors.light_text_primary,
    surfaceVariant = palette?.bg_secondary ?: AsterColors.light_bg_secondary,
    onSurfaceVariant = palette?.text_tertiary ?: AsterColors.light_text_tertiary,
    surfaceTint = palette?.accent_color ?: AsterColors.accent_blue,
    inverseSurface = AsterColors.dark_bg_card,
    inverseOnSurface = AsterColors.dark_text_primary,
    outline = palette?.border_primary ?: AsterColors.light_border_primary,
    outlineVariant = palette?.border_secondary ?: AsterColors.light_border_secondary,
...
private fun build_dark_color_scheme(palette: ColorThemePalette?) = darkColorScheme(
    ...
    onSecondary = palette?.bg_primary ?: AsterColors.dark_bg_primary,
    secondaryContainer = AsterColors.dark_secondary,
    onSecondaryContainer = palette?.text_primary ?: AsterColors.dark_text_primary,
    tertiary = palette?.text_tertiary ?: AsterColors.dark_text_tertiary,
    onTertiary = palette?.bg_primary ?: AsterColors.dark_bg_primary,
    background = palette?.bg_primary ?: AsterColors.dark_bg_primary,
    onBackground = palette?.text_primary ?: AsterColors.dark_text_primary,
    surface = palette?.bg_card ?: AsterColors.dark_bg_card,
    onSurface = palette?.text_primary ?: AsterColors.dark_text_primary,
    surfaceVariant = palette?.bg_secondary ?: AsterColors.dark_bg_secondary,
    onSurfaceVariant = palette?.text_tertiary ?: AsterColors.dark_text_tertiary,
    surfaceTint = Color.Transparent,
    inverseSurface = AsterColors.light_bg_card,
    inverseOnSurface = AsterColors.light_text_primary,
    outline = palette?.border_primary ?: AsterColors.dark_border_primary,
    outlineVariant = palette?.border_secondary ?: AsterColors.dark_border_secondary,
    error = AsterColors.danger,
    onError = Color.White,
