...
class AsterApplication : Application(), ImageLoaderFactory {
    ...
    override fun onCreate() {
        ...
        kotlinx.coroutines.CoroutineScope(kotlinx.coroutines.Dispatchers.IO).launch {
            runCatching { org.astermail.android.ui.theme.theme_manifest.load_cached(this@AsterApplication) }
        }
    ...
    private fun start_deferred_startup() {
        Thread {
            ...
            runCatching { org.astermail.android.ui.mail.purge_legacy_skeleton_rows(this) }
            ...
            runCatching {
                org.astermail.android.notifications.PersistentPushService.start_if_enabled(this)
            }
