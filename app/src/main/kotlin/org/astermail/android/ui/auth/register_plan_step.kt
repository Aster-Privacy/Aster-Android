...
private val fallback_plans = listOf(
    AvailablePlan(
        ...
        storage_limit_bytes = 1L * 1024 * 1024 * 1024,
        max_email_aliases = 1,
    ...
    AvailablePlan(
        ...
        code = "starter",
        name = "Starter",
        description = "For everyday privacy",
        storage_limit_bytes = 10L * 1024 * 1024 * 1024,
        max_email_aliases = 10,
        ...
        Column {
            Row(verticalAlignment = Alignment.CenterVertically) {
                val localized_name = when (plan.code.lowercase()) {
                    ...
                    "starter" -> stringResource(R.string.plan_name_starter)
                    "professional" -> stringResource(R.string.plan_name_professional)
            ...
            val localized_desc = when (plan.code.lowercase()) {
                ...
                "starter" -> stringResource(R.string.plan_desc_everyday_privacy)
                "professional" -> stringResource(R.string.plan_desc_power_users)
