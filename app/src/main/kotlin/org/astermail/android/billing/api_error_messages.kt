...
fun localized_api_error(context: Context, t: Throwable, fallback: String): String {
    ...
    return when (t) {
        ...
        is ApiError.ForbiddenError -> context.getString(R.string.error_forbidden)
        ...
        is ApiError.Conflict -> context.getString(R.string.error_conflict)
        is ApiError.ValidationError -> fallback
